...
void Dropdown::arrow1( Point p ) {
	render::rect_filled( p.x + m_w - 11, p.y + m_offset + 9 + 2, 1, 1, { 255, 255, 255, m_parent->m_alpha } );
	render::rect_filled( p.x + m_w - 10, p.y + m_offset + 9 + 2, 1, 1, { 255, 255, 255, m_parent->m_alpha } );
	render::rect_filled( p.x + m_w - 9, p.y + m_offset + 9 + 2, 1, 1, { 255, 255, 255, m_parent->m_alpha } );
	render::rect_filled( p.x + m_w - 8, p.y + m_offset + 9 + 2, 1, 1, { 255, 255, 255, m_parent->m_alpha } );
	render::rect_filled( p.x + m_w - 7, p.y + m_offset + 9 + 2, 1, 1, { 255, 255, 255, m_parent->m_alpha } );

	render::rect_filled( p.x + m_w - 10, p.y + m_offset + 9 + 1, 1, 1, { 255, 255, 255, m_parent->m_alpha } );
	render::rect_filled( p.x + m_w - 9, p.y + m_offset + 9 + 1, 1, 1, { 255, 255, 255, m_parent->m_alpha } );
	render::rect_filled( p.x + m_w - 8, p.y + m_offset + 9 + 1, 1, 1, { 255, 255, 255, m_parent->m_alpha } );
	render::rect_filled( p.x + m_w - 9, p.y + m_offset + 9, 1, 1, { 255, 255, 255, m_parent->m_alpha } );
}

void Dropdown::arrow2( Point l ) {
	render::rect_filled( l.x + m_w - 11, l.y + m_offset + 9, 1, 1, { 255, 255, 255, m_parent->m_alpha } );
	render::rect_filled( l.x + m_w - 10, l.y + m_offset + 9, 1, 1, { 255, 255, 255, m_parent->m_alpha } );
